...
//    public static LoggedTunableNumber autoDrive_kP = new LoggedTunableNumber("AutoDrive/kP", 9.0);
//    public static LoggedTunableNumber autoDrive_kI = new LoggedTunableNumber("AutoDrive/kI", 0.0);
//    public static LoggedTunableNumber autoDrive_kD = new LoggedTunableNumber("AutoDrive/kD", 0.1);
//
//    public static LoggedTunableNumber autoSteer_kP = new LoggedTunableNumber("AutoSteer/kP", 24.1);
//    public static LoggedTunableNumber autoSteer_kI = new LoggedTunableNumber("AutoSteer/kI", 0.0);
//    public static LoggedTunableNumber autoSteer_kD = new LoggedTunableNumber("AutoSteer/kD", 1.0);
    public static LoggedTunableNumber autoDrive_kP = new LoggedTunableNumber("AutoDrive/kP", 5.0);
    public static LoggedTunableNumber autoDrive_kI = new LoggedTunableNumber("AutoDrive/kI", 0.0);
    public static LoggedTunableNumber autoDrive_kD = new LoggedTunableNumber("AutoDrive/kD", 0.0);

    public static LoggedTunableNumber autoSteer_kP = new LoggedTunableNumber("AutoSteer/kP", 15.0);
    public static LoggedTunableNumber autoSteer_kI = new LoggedTunableNumber("AutoSteer/kI", 0.0);
    public static LoggedTunableNumber autoSteer_kD = new LoggedTunableNumber("AutoSteer/kD", 0.0);
